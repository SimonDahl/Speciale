...
def sho(t,y):
    solution = (y[1],(-(c/m_known)*y[1]-(k_known/m_known)*y[0]))
    return solution
...
y_b = [sol_data[0],sol_data[3],sol_data[5],sol_data[10],sol_data[18],sol_data[32],sol_data[45],sol_data[65],sol_data[70],sol_data[73],sol_data[98]]
y_b = np.array([y_b])
  

x_b = [t[0],t[3],t[5],t[10],t[18],t[32],t[45],t[65],t[70],t[73],t[98]]
n_data = len(x_b)
